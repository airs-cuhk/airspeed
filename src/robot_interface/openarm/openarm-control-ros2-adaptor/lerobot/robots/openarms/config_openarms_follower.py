...
class OpenArmsFollowerConfig(RobotConfig):
    ...
    max_relative_target: Optional[float | Dict[str, float]] = 2.0

    # Maximum total deviation from initial position (degrees)
    # Prevents robot from moving too far from starting configuration
    max_total_deviation: Optional[float] = 30.0
