    ...
    try:
        ...
        if follower.pin_robot is None and urdf_path:
            try:
                ...
                print("")
                print("      To enable gravity compensation, install lerobot with meshes:")
                print("        pip install lerobot")
                print("        cp -r $(python3 -c 'import lerobot.robots.openarms as p,os;")
                print("                 print(os.path.dirname(p.__file__))')/urdf/meshes \\")
