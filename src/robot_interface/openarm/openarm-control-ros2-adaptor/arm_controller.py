    ...
    try:
        ...
        if follower.pin_robot is None and urdf_path:
            try:
                ...
                print("")
                print("      To enable gravity compensation, copy meshes to the IK adaptor:")
                ...
                print("          ../openarm-ik-ros2-adaptor/frontend/3d_assets/urdf/meshes/")
                print("      The controller auto-copies meshes on next start.")
                print("      ─────────────────────────────────────────────")
